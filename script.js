...
function editSong(id) {
    ...
    if (song) {
        ...
        // Eliminar la canción actual y permitir re-agregar
        deleteSong(id);
...
function renderTable(filteredSongs = null) {
    ...
    if (sortedSongs.length === 0) {
        tableBody.innerHTML = '<tr><td colspan="4" style="text-align: center; padding: 30px; color: #999;">No hay canciones registradas</td></tr>';
        return;
    }
